...
import { AtWorkListEffects, AtWorkListSelectors, StatusesTypes, Types } from 'store';
import { useDispatch, useSelector } from 'react-redux';
import { InputNumber as InputNumberAnt, InputNumberProps, List as ListAnt, ListProps } from 'antd';
import styled from 'styled-components';
import { HeaderCard, Hooks, Helpers } from 'shared';
    ...
    <BoxWrap ref={ref}>
      <InboxWrap>
        <List
          header={
            <HeaderCard
              title={Types.TitlesCards.inWork}
              taskStatus={StatusesTypes.statusesId.inWork}
              listSort={sort}
            />
          }
          dataSource={listData}
...
const List = styled(ListAnt)<ListProps<Types.TaskCardType>>`
  display: grid;
